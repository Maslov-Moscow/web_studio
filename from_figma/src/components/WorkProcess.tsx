  ...
  return (
    <div className="relative group">
      ...
      <div className="relative">
        {/* Number Badge */}
        <div className="absolute -top-3 -left-3 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-purple-600 text-xs text-white">
          {step.number}
        </div>
